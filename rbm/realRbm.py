...
from newUpsonRbm import loadUpsonData
...
class RealRBM(object):
    '''
    Implements a Restricted Boltzmann Machine with a real-valued visible layer.
    '''
    ...
    def __init__(self, nVisible, nHidden, numpyRng, theanoRng):
        ...
        self.W = numpy.asarray(self.numpyRng.uniform(low = -4*numpy.sqrt(6./(self.nHidden+self.nVisible)) / 100.,
                                                     high = 4*numpy.sqrt(6./(self.nHidden+self.nVisible)) / 100.,
...
if __name__ == '__main__':
    ...
    print 'TODO: try normalizing data first (to u=0,s=1 or just s=1)'
