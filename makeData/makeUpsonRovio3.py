...
def main():
    ...
    for Nw in [2, 3, 4, 6, 8, 10, 15, 20, 25, 28, 30, 40]:
        ...
        sav(flnm % ('explore_%02d_50_1c' % Nw),    rsm(exploreFilter, 2*big-Nw, False, Nw = Nw, Nsamples = 50))
        ...
        sav(flnm % ('explore_%02d_50000_1c' % Nw), rsm(exploreFilter, 2*big-Nw, False, Nw = Nw, Nsamples = 50000))
    ...
    for Nw in [2, 3, 4, 6, 8, 10, 15, 20, 25, 28, 30, 40]:
        ...
        sav(flnm % ('explore_%02d_50_3c' % Nw),    rsm(exploreFilter, 2*big-Nw, True, Nw = Nw, Nsamples = 50))
        ...
        sav(flnm % ('explore_%02d_50000_3c' % Nw), rsm(exploreFilter, 2*big-Nw, True, Nw = Nw, Nsamples = 50000))
